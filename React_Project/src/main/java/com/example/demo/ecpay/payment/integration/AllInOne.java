package com.example.demo.ecpay.payment.integration;
...
import com.example.demo.ecpay.payment.integration.domain.ATMRequestObj;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutALL;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutApplePay;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutATM;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutCVS;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutDevide;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutOneTime;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutPeriod;
import com.example.demo.ecpay.payment.integration.domain.AioCheckOutWebATM;
import com.example.demo.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import com.example.demo.ecpay.payment.integration.domain.CreateServerOrderObj;
import com.example.demo.ecpay.payment.integration.domain.DoActionObj;
import com.example.demo.ecpay.payment.integration.domain.FundingReconDetailObj;
import com.example.demo.ecpay.payment.integration.domain.InvoiceObj;
import com.example.demo.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import com.example.demo.ecpay.payment.integration.domain.QueryTradeInfoObj;
import com.example.demo.ecpay.payment.integration.domain.QueryTradeObj;
import com.example.demo.ecpay.payment.integration.domain.TradeNoAioObj;
import com.example.demo.ecpay.payment.integration.ecpayOperator.EcpayFunction;
...
import com.example.demo.ecpay.payment.integration.verification.VerifyAioCheckOut;
import com.example.demo.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import com.example.demo.ecpay.payment.integration.verification.VerifyDoAction;
import com.example.demo.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import com.example.demo.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import com.example.demo.ecpay.payment.integration.verification.VerifyQueryTrade;
import com.example.demo.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import com.example.demo.ecpay.payment.integration.verification.VerifyTradeNoAio;
